---
title: The need for ML design patterns
---
import NotePage from '@/src/app/ui/NotePage'

export default ({ children }) => ( <NotePage title="The need for" highlight="ML" after="design patterns"> {children} </NotePage> )
...
# Resources used for these notes - [Machine Learning Design Patterns | Lakshmanan, Robinson, Munn](https://learning.oreilly.com/library/view/-/9781098115777/)
